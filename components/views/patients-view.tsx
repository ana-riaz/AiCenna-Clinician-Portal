                ...
                <div className="flex items-center justify-between p-4 border-b border-glass-border">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="py-1.5 px-2.5 text-[11px] font-semibold bg-glass-strong border border-glass-border rounded-lg text-muted hover:bg-[rgba(56,189,248,0.15)] hover:border-[#38bdf8] hover:text-[#38bdf8] transition-all"
                    >
                      Preview
                    </button>
                  </div>
