...
export function OverviewTab({ patientId }: OverviewTabProps) {
  const { vitalFilter, setVitalFilter } = useApp();
    ...
    <div className="flex-1 overflow-y-auto p-5 flex flex-col gap-3">
      ...
      <div className="grid grid-cols-[315px_1fr] gap-3.5 items-stretch">
        ...
        <div className="flex flex-col items-center px-4">
          ...
          <div className="flex-1 min-h-0 overflow-hidden flex items-center justify-center cursor-pointer transition-opacity hover:opacity-85">
