    ...
    <div className="p-5 flex flex-col gap-3">
      <div className="flex items-center justify-between">
        <div>
          ...
          <div className="text-[9px] text-dim mt-0.5">Current values from connected sources</div>
        </div>
      ...
      <div className="grid grid-cols-[260px_1fr] gap-3.5 items-stretch">
        <div className="glass-card flex flex-col items-center px-4 py-3">
          <div className="text-[10px] font-bold text-dim uppercase tracking-widest mb-2 text-center flex-shrink-0">
            Digital Twin
          </div>
          <div
          ...
          >
            <DigitalTwinHologram patientId={patientId} className="h-full max-h-[330px]" />
          </div>
        </div>
