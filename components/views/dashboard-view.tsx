          ...
          {filteredPatients.map((patient) => {
            ...
            return (
              <button
                ...
                className="w-full grid grid-cols-[2fr_1fr_1fr_90px] gap-2 py-3 px-4 items-center cursor-pointer transition-colors border-b border-[rgba(255,255,255,0.04)] last:border-b-0 hover:bg-glass text-left"
              >
                {/* Patient Info */}
                ...
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                    openPatient(patient.id, "ov", "dash");
                  }}
